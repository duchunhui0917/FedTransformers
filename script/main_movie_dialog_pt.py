...
task_name = 'cornell_movie_dialogue'
dataset_path = os.path.join(base_dir, f"data/{task_name}_data.h5")
model_name = 't5-small'
tunning_name = ''
model_path = os.path.join(base_dir,
                          f"ckpt/centralized/{task_name}_s223_800_800/{model_name}_{tunning_name}_tgwg")
...
config = [
    ...
    '--train_batch_size=16',
    '--eval_batch_size=16',
    '--max_train_samples=4936',
    '--max_eval_samples=4936',
    # '--num_epochs=5',
    '--seed=223',
    '--num_iterations=100',
]
...
if model_args.tunning_method != 'None':
...
if fl_args.split_type == 'label_split':
    ...
    ckpt = f'{model_name}_{fl_args.n_clients}_{fl_args.num_epochs}'
