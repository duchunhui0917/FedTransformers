...
task_name = '20news_class6'
dataset_path = os.path.join(base_dir, f"data/20news_class6_data.h5")
algorithm = 'FedAvg'
split_type = 'label_split'
model_name = 'bert-base-uncased'
tunning_name = 'P-Tunning_v2'
model_path = os.path.join(base_dir,
                          f"ckpt/{algorithm}/20news_class6_s223_800_800/{model_name}_{tunning_name}_0.5_100_5_tgwg")
