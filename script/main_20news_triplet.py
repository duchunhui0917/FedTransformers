...
model_path = os.path.join(base_dir,
                          f"ckpt/centralized/20news_s223/{model_name}_anchor_tgwg")
...
template_text = 'The topic of news: {"mask"}. This is a {"placeholder":"text_b"} news. {"sep"}' \
                'The topic of news: {"mask"}. This is a {"placeholder":"text_c"} news. {"sep"}' \
                'The topic of news: {"mask"}. {"placeholder":"text_a"}'
verbalizer = 'triplet'
tunning_name = 'triplet'
config = [
