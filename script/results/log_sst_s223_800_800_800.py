...
centralized_FT = os.path.join(base_dir,
                              'log/centralized/sst_s223_800_800_800/bert-base-uncased_22-07-28 20:58.log')
centralized_PET = os.path.join(base_dir,
                               'log/centralized/sst_s223_800_800_800/bert-base-uncased_PET_22-07-29 21:10.log')

centralized_WARP = os.path.join(base_dir,
                                'log/centralized/sst_s223_800_800_800/bert-base-uncased_WRAP_22-07-29 16:57.log')
centralized_proto = os.path.join(base_dir,
                                 'log/centralized/sst_s223_800_800_800/bert-base-uncased_proto_22-07-29 19:53.log')

centralized_anchor = os.path.join(base_dir,
                                  'log/centralized/sst_s223_800_800_800/bert-base-uncased_anchor_22-07-29 20:49.log')

FedAvg_FT = os.path.join(base_dir,
                         'log/FedAvg/sst_s223_800_800_800/bert-base-uncased_0.1_10_5_22-07-31 20:03.log')
FedAvg_PET = os.path.join(base_dir,
                          'log/FedAvg/sst_s223_800_800_800/bert-base-uncased_PET_0.1_10_5_22-08-01 08:37.log')
FedAvg_WARP = os.path.join(base_dir,
                           'log/FedAvg/sst_s223_800_800_800/bert-base-uncased_WRAP_0.1_10_5_22-07-31 20:02.log')
FedAvg_Proto = os.path.join(base_dir,
                            'log/FedAvg/sst_s223_800_800_800/bert-base-uncased_proto_0.1_10_5_22-07-31 16:02.log')
FedAvg_ours = os.path.join(base_dir,
                           'log/FedAvg/sst_s223_800_800_800/bert-base-uncased_anchor_0.1_10_5_22-07-31 13:44.log')
...
for key, val in FedAvg_d.items():
    with open(val, 'r') as f:
        len2 = 61 if key in ['ours'] else 101
        lines = f.readlines()
        ls = process(lines)
...
plt.xlabel('Communication rounds')
plt.ylabel('F1 score (%) on validation dataset')
plt.title(r'SST-5/K=800/$\alpha$=0.1')
plt.show()
