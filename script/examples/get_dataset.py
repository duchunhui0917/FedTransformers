...
class SuperGlueDataset:
    def __init__(self, tokenizer: AutoTokenizer, data_args, training_args) -> None:
        ...
        self.sentence1_key, self.sentence2_key = superglue_task_to_keys[data_args.task_name]
        ...
        self.metric = load_metric("super_glue", data_args.task_name)
        ...
        self.test_key = "accuracy" if data_args.task_name not in ["record", "multirc"] else "f1"
...
class GlueDataset:
    def __init__(self, tokenizer: AutoTokenizer, data_args, training_args) -> None:
        ...
        # Preprocessing the raw_datasets
        self.sentence1_key, self.sentence2_key = glue_task_to_keys[data_args.task_name]
