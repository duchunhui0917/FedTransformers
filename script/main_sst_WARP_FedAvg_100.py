...
model_path = os.path.join(base_dir,
                          f"ckpt/FedAvg/sst_s223_100_100_100/{model_name}_WRAP_{dirichlet_alpha}_10_5_tgwg")
labels_names = ['negative', 'somewhat negative', 'neutral', 'somewhat positive', 'positive']
label_words = [
...
if num_labels != 1:
    if fl_args.algorithm != 'centralized':
        ...
        plot_class_samples(mtx, label_names=labels_names)
