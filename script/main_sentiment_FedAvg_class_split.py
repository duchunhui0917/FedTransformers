...
task_name = 'sentiment'
dataset_path = os.path.join(base_dir, f"data/sentiment_data.h5")
model_type = 'bert'
model_name = 'bert-base-uncased'
dirichlet_alpha = 0.1
tunning_method = 'bottleneck_adapter'
prompt_method = None
seed = 223
classes = [[0], [1]]
model_path = os.path.join(base_dir,
                          f"ckpt/FedAvg/sst_s223_800_800_800/{model_name}_{dirichlet_alpha}_10_5_tgwg")
